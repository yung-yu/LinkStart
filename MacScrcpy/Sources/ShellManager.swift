    ...
    func isScrcpyRunning(deviceId: String?, isVirtual: Bool, packageId: String? = nil) -> Bool {
        do {
            ...
            for line in lines {
                ...
                // Ensure we match 'scrcpy' binary but NOT 'MacScrcpy' (this app)
                let isActualScrcpy = (trimmedLine.hasPrefix("scrcpy") || trimmedLine.contains("/scrcpy")) && !trimmedLine.contains("MacScrcpy.app")
